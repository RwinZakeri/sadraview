...
const db = mysql.createPool({ 
    host: process.env.CLEVER_CLOUD_MYSQL_HOST || 'localhost' ,
    user: process.env.CLEVER_CLOUD_MYSQL_USER ||  'root',
    password: process.env.CLEVER_CLOUD_MYSQL_PASSWORD || '',
    database: process.env.CLEVER_CLOUD_MYSQL_DATABASE || 'sadra-db-core',
});
